package net.fabricmc.example.world.structure;
...
public class laoda_temple extends Structure {

    // A custom codec that changes the size limit for our code_structure_sky_fan.json's config to not be capped at 7.
    // With this, we can have a structure with a size limit up to 30 if we want to have extremely long branches of pieces in the structure.
    public static final Codec<laoda_temple> CODEC = RecordCodecBuilder.<laoda_temple>mapCodec(instance ->
            instance.group(laoda_temple.configCodecBuilder(instance),
            ...
            ).apply(instance, laoda_temple::new)).codec();
    ...
    public laoda_temple(Structure.Config config,
    ...
    public Optional<Structure.StructurePosition> getStructurePosition(Structure.Context context) {
        ...
        if (!laoda_temple.extraSpawningChecks(context)) {
    ...
    public StructureType<?> getType() {
        return ExampleMod.LAODA_TEMPLE; // Helps the game know how to turn this structure back to json to save to chunks
    }
}